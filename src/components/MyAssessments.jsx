...
// MyAssessments — Employee's read-only view of their own assessment results
// Props: employeeId
export default function MyAssessments({ employeeId }) {
  const { db } = useAuth();
  ...
  return (
    <div className="table-wrapper">
      <table className="data-table" id="my-assessments-table">
        <thead>
          <tr>
            <th>#</th>
            <th>Assessment</th>
